...
private:
    ...
    void pushSampleToMixer(float sample, unsigned int channel);

private:
    Memory* m_memory = nullptr;
    AudioLayer* m_audio_layer = nullptr;
    float m_mixer_buffer[4] = {0, 0, 0, 0};
    ...
    static constexpr uint16_t CHANNEL_2_VOLUME_AND_ENVELOPE_ADDR = 0xF17; // NR12
    static constexpr uint16_t CHANNEL_2_PERIOD_LOW_ADDR = 0xFF18; // NR13
    static constexpr uint16_t CHANNER_2_PERIOD_HIGH_ADDR = 0xFF19; // NR14
